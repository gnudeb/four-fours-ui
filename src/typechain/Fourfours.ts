...
export interface FourfoursInterface extends utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "claim(string)": FunctionFragment;
    "compute(string)": FunctionFragment;
    ...
    "solutions(uint256)": FunctionFragment;
...
export interface Fourfours extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FourfoursInterface;
